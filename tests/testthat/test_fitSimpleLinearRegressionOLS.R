...
test_that("Line is fit and other values are computed correctly", {
	...
	expect_equal(a[[9]], 12.7654, tolerance = tol)
	expect_equal(a[[10]], 0.14819, tolerance = tol)
	expect_equal(a[[11]], 0.29638, tolerance = tol)
	expect_equal(a[[12]], 0.84901, tolerance = tol)
	expect_equal(a[[13]], 0.99907, tolerance = tol)
})
